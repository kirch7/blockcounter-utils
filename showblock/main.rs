...
fn main() {
    ...
    if is_a_tty {
        ...
        println!("{}", blockcounter::Blocks::new(tolerance, file).nth(block).unwrap());
    } else {
        use std::io::Read;
        ...
        let _ = stdin_
            ...
            .unwrap();
        println!("{}", blockcounter::Blocks::new(tolerance, s.as_bytes()).nth(block).unwrap());
    }
}
